...
{
    public partial class IngresoPorTipoOperacion : Form
    {
        private int id_top;
        private DateTime desde;
        private DateTime hasta;
        public IngresoPorTipoOperacion(int id_top, DateTime desde, DateTime hasta)
        {
            InitializeComponent();
            this.id_top = id_top;
            this.desde = desde;
        ...
        private void IngresoPorTipoOperacion_Load(object sender, EventArgs e)
        {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            if (filtroDesde.Value.Date == filtroHasta.Value.Date)
                this.printableLV.Title = "Ingresos por tipo de operación";
            else
            {
                this.printableLV.Title = "Ingresos por tipo de operación desde el " + filtroDesde.Value.Date.ToString("dd/MM/yyyy") + " hasta el " + filtroHasta.Value.Date.ToString("dd/MM/yyyy");
            }
